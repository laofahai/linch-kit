...
2. **文档导航**: 阅读 `ai-context/README.md` 了解文档结构
3. **项目愿景**: 快速浏览 `ai-context/1_vision_and_scope.md`
4. **架构理解**: 参考 `ai-context/2_architecture_and_design.md`
5. **工作流程**: **必读** `ai-context/3_workflow_and_constraints.md`
6. **当前状态**: 查看 `ai-context/4_roadmap_and_status.md`
7. **分支检查**: 如在 main 分支则创建功能分支
8. **确认完成**: 确保所有初始化步骤完成
...
### 🎯 新文档结构 (已重新组织)
- **📋 文档导航**: `ai-context/README.md` - AI 助手的首要入口和文档索引
- **🎯 项目愿景**: `ai-context/1_vision_and_scope.md` - 项目目标和核心价值
- **🏗️ 架构设计**: `ai-context/2_architecture_and_design.md` - 系统架构和设计决策
- **🛠️ 工作流程**: `ai-context/3_workflow_and_constraints.md` - 开发规范和技术约束
- **📈 路线图状态**: `ai-context/4_roadmap_and_status.md` - 当前进度和未来计划

### 📚 参考资料
- **📖 API参考**: `ai-context/reference/packages_api.md` - 包功能详细参考
- **🤖 AI设计**: `ai-context/reference/modules/ai_package_design.md` - AI包详细设计

### 🗄️ 历史归档
- **📜 开发历史**: `ai-context/archive/development_history.md` - 历史记录和决策

## 🔒 基础约束

必须严格遵守以下约束（详见 `ai-context/3_workflow_and_constraints.md`）：
...
### 开发流程
当用户开始新任务时：
1. **文档导航** - 阅读 `ai-context/README.md` 了解文档结构
2. **理解愿景** - 快速浏览 `ai-context/1_vision_and_scope.md` 了解项目目标
3. **掌握架构** - 参考 `ai-context/2_architecture_and_design.md` 理解系统设计
4. **遵循规范** - **必读** `ai-context/3_workflow_and_constraints.md` 中的约束
5. **了解现状** - 查看 `ai-context/4_roadmap_and_status.md` 了解当前进度
