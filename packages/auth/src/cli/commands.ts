...
export const initAuthCommand: CLICommand = {
  ...
  handler: async ({ options, t }) => {
    ...
    try {
      ...
      logError(
        authT('cli.init.error', { error: errorMessage }),
...
export const createUserCommand: CLICommand = {
  ...
  handler: async ({ options, t }) => {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Unknown error'
      logError(
        authT('cli.user.create.error', { error: errorMessage }),
        error instanceof Error ? error : undefined
      )
      return { success: false, error: errorMessage }
    }
...
export const listUsersCommand: CLICommand = {
  ...
  handler: async ({ options: _options, t }) => {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Unknown error'
      logError(
        authT('cli.user.list.error', { error: errorMessage }),
        error instanceof Error ? error : undefined
      )
      return { success: false, error: errorMessage }
    }
...
export const resetPasswordCommand: CLICommand = {
  ...
  handler: async ({ options, t }) => {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Unknown error'
      logError(
        authT('cli.password.reset.error', { error: errorMessage }),
        error instanceof Error ? error : undefined
      )
      return { success: false, error: errorMessage }
    }
...
export const setupMFACommand: CLICommand = {
  ...
  handler: async ({ options, t }) => {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Unknown error'
      logError(
        authT('cli.mfa.setup.error', { error: errorMessage }),
        error instanceof Error ? error : undefined
      )
      return { success: false, error: errorMessage }
    }
...
export const auditCommand: CLICommand = {
  ...
  handler: async ({ options: _options, t }) => {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Unknown error'
      logError(
        authT('cli.audit.error', { error: errorMessage }),
        error instanceof Error ? error : undefined
      )
      return { success: false, error: errorMessage }
    }
