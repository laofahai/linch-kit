...
const defaultMessages = {
  'zh-CN': {
    ...
    'dashboard.stats.totalTenants': '总租户数',
    'dashboard.stats.totalUsers': '总用户数',
    'dashboard.stats.activePlugins': '活跃插件',
    'dashboard.stats.systemLoad': '系统负载',
    'dashboard.systemHealth.title': '系统健康状态',
    'dashboard.systemHealth.status.healthy': '健康',
    'dashboard.systemHealth.status.warning': '警告',
    'dashboard.systemHealth.status.error': '错误',
    'dashboard.systemHealth.lastCheck': '最后检查',
    'dashboard.quickActions.title': '快速操作',
    'dashboard.quickActions.createTenant': '创建租户',
    'dashboard.quickActions.manageUsers': '管理用户',
    'dashboard.quickActions.managePlugins': '管理插件',
    'dashboard.quickActions.viewMonitoring': '查看监控',
    'dashboard.quickActions.viewLogs': '查看日志',
    'dashboard.recentActivity.title': '最近活动',
    'dashboard.recentActivity.empty': '暂无活动记录',
    'dashboard.systemResources.title': '系统资源',
    'dashboard.systemResources.cpu': 'CPU',
    'dashboard.systemResources.memory': '内存',
    'dashboard.systemResources.disk': '磁盘',
    'dashboard.tenantOverview.title': '租户概览',
    'dashboard.tenantOverview.columns.name': '名称',
    'dashboard.tenantOverview.columns.status': '状态',
    'dashboard.tenantOverview.columns.users': '用户数',
    'dashboard.tenantOverview.columns.plugins': '插件数',
    'dashboard.tenantOverview.empty': '暂无租户',
    'dashboard.pluginStatus.title': '插件状态',
    'dashboard.pluginStatus.empty': '暂无插件',
    ...
    // Extension 管理
    'extension.manager.title': 'Extension 管理',
    'extension.manager.description': 'Extension 系统运行状态和管理',
    'extension.manager.refresh': '刷新',
    'extension.manager.install': '安装',
    'extension.manager.settings': '设置',
    'extension.manager.search': '搜索 Extensions...',
    'extension.manager.filter.all': '全部',
    'extension.manager.filter.running': '运行中',
    'extension.manager.filter.error': '错误',
    'extension.manager.filter.stopped': '已停止',
    'extension.manager.stats.total': '总数',
    'extension.manager.stats.loaded': '已加载',
    'extension.manager.stats.failed': '失败',
    'extension.manager.stats.stopped': '已停止',
    'extension.manager.list.title': 'Extension 列表',
    'extension.manager.empty.title': '暂无 Extensions',
    'extension.manager.empty.description': '还没有加载任何 Extensions',
    'extension.manager.status.running': '运行中',
    'extension.manager.status.loading': '加载中',
    'extension.manager.status.error': '错误',
    'extension.manager.status.stopped': '已停止',
    'extension.manager.status.loaded': '已加载',
    'extension.manager.status.failed': '失败',
    'extension.manager.routes': '路由',
    'extension.manager.components': '组件',
    'extension.manager.startedAt': '启动时间',
    'extension.details.overview': '概览',
    'extension.details.resources': '资源',
    'extension.details.logs': '日志',
    'extension.details.basic': '基本信息',
    'extension.details.name': '名称',
    'extension.details.status': '状态',
    'extension.details.startedAt': '启动时间',
    'extension.details.error': '错误信息',
    'extension.details.logsContent.empty': '暂无日志内容',
    'extension.install.title': '安装 Extension',
    'extension.install.selectExtension': '选择 Extension',
    'extension.install.pleaseSelect': '请选择...',
    'extension.install.install': '安装',
  ...
  en: {
    ...
    'dashboard.stats.activePlugins': 'Active Plugins',
    'dashboard.stats.systemLoad': 'System Load',
    'dashboard.systemHealth.title': 'System Health',
    'dashboard.systemHealth.status.healthy': 'Healthy',
    'dashboard.systemHealth.status.warning': 'Warning',
    'dashboard.systemHealth.status.error': 'Error',
    'dashboard.systemHealth.lastCheck': 'Last Check',
    'dashboard.quickActions.title': 'Quick Actions',
    'dashboard.quickActions.createTenant': 'Create Tenant',
    'dashboard.quickActions.manageUsers': 'Manage Users',
    'dashboard.quickActions.managePlugins': 'Manage Plugins',
    'dashboard.quickActions.viewMonitoring': 'View Monitoring',
    ...
    'dashboard.systemResources.title': 'System Resources',
    'dashboard.systemResources.cpu': 'CPU',
    'dashboard.systemResources.memory': 'Memory',
    'dashboard.systemResources.disk': 'Disk',
    'dashboard.tenantOverview.title': 'Tenant Overview',
    'dashboard.tenantOverview.columns.name': 'Name',
    'dashboard.tenantOverview.columns.status': 'Status',
    'dashboard.tenantOverview.columns.users': 'Users',
    'dashboard.tenantOverview.columns.plugins': 'Plugins',
    'dashboard.tenantOverview.empty': 'No tenants',
    'dashboard.pluginStatus.title': 'Plugin Status',
    'dashboard.pluginStatus.empty': 'No plugins',
    ...
    'extension.manager.title': 'Extension Management',
    'extension.manager.description': 'Extension system status and management',
    'extension.manager.refresh': 'Refresh',
    'extension.manager.install': 'Install',
    'extension.manager.settings': 'Settings',
    'extension.manager.search': 'Search Extensions...',
    'extension.manager.filter.all': 'All',
    'extension.manager.filter.running': 'Running',
    'extension.manager.filter.error': 'Error',
    'extension.manager.filter.stopped': 'Stopped',
    'extension.manager.stats.total': 'Total',
    'extension.manager.stats.loaded': 'Loaded',
    'extension.manager.stats.failed': 'Failed',
    'extension.manager.stats.stopped': 'Stopped',
    'extension.manager.list.title': 'Extension List',
    'extension.manager.empty.title': 'No Extensions',
    'extension.manager.empty.description': 'No extensions loaded yet',
    'extension.manager.status.running': 'Running',
    'extension.manager.status.loading': 'Loading',
    'extension.manager.status.error': 'Error',
    'extension.manager.status.stopped': 'Stopped',
    'extension.manager.status.loaded': 'Loaded',
    'extension.manager.status.failed': 'Failed',
    'extension.manager.routes': 'Routes',
    'extension.manager.components': 'Components',
    'extension.manager.startedAt': 'Started At',
    'extension.details.overview': 'Overview',
    'extension.details.resources': 'Resources',
    'extension.details.logs': 'Logs',
    'extension.details.basic': 'Basic Information',
    'extension.details.name': 'Name',
    'extension.details.status': 'Status',
    'extension.details.startedAt': 'Started At',
    'extension.details.error': 'Error Information',
    'extension.details.logsContent.empty': 'No log content',
    'extension.install.title': 'Install Extension',
    'extension.install.selectExtension': 'Select Extension',
    'extension.install.pleaseSelect': 'Please select...',
    'extension.install.install': 'Install',
