...
const logger = {
  info: (msg, meta) => console.log(`[Evolution-Engine] ${msg}`, meta || ''),
  warn: (msg, meta) => console.warn(`[Evolution-Engine] ${msg}`, meta || ''),
  error: (msg, meta) => console.error(`[Evolution-Engine] ${msg}`, meta || ''),
