...
export declare function createLibraryConfig(
  options?: Omit<TsupBaseOptions, 'isCli'>
):
  | Options
  | Options[]
 ...
 * React 组件库配置
 */
export declare function createReactConfig(
  options?: Omit<TsupBaseOptions, 'isReact'>
):
  | Options
  | Options[]
  | ((overrideOptions: Options) => Options | Options[] | Promise<Options | Options[]>)
 ...
 * 多入口配置
 */
export declare function createMultiEntryConfig(
